...
> * Examples: Netflix movie recommendations, Amazon products
...
A big part of machine learning is **prediction**. Can you take predictor information
...
* the independent variables $x_1, x_2, ...$
...
> * Econometrics, biology, many social sciences are concerned with: *if I change x, how does this impact y*?
...
> * Treats regression as a **black box**
